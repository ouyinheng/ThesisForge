...
const messages = {
  zh: {
    ...
    accentDefault: '默认',
    videoStation: '厂长资源地址',
    videoStationDesc: '厂长资源官网域名，更换时更新此项',
    showTabs: '标签页',
    showTabsOn: '显示',
    showTabsOff: '隐藏',
    // 待办
    ...
    collection: {
      ...
      addBookmark: '添加书签',
      editBookmark: '编辑书签',
      urlPlaceholder: '输入链接，如 github.com',
      titlePlaceholder: '输入名称（可留空自动获取）',
      selectGroup: '选择分组',
      ungrouped: '未分组',
      all: '全部',
      search: '搜索书签...',
    ...
    novel: {
      ...
      categoryPresets: '玄幻、都市、科幻、历史、武侠、悬疑、言情、游戏',
      status: '状态',
      statusDraft: '草稿',
      statusOngoing: '连载中',
      statusFinished: '已完结',
      dailyGoal: '每日目标字数',
      intro: '简介',
      introPlaceholder: '一句话介绍你的作品（可选）',
      enterTitle: '请输入书名',
      created: '作品已创建',
      updateSuccess: '作品已更新',
      deleted: '作品已删除',
      deleteConfirm: '确定要删除这部作品吗？所有章节将一并删除，此操作不可撤销。',
      noIntro: '暂无简介',
      empty: '还没有作品，创建第一部小说开始码字吧',
      unitYi: '亿',
      unitWan: '万',
      unitQian: '千',
      updatedAt: '更新',
      ...
      contentPlaceholder: '在此开始你的故事…',
      untitled: '未命名章节',
      noChapters: '还没有章节',
      chapterDeleted: '章节已删除',
      deleteChapterConfirm: '确定删除该章节吗？内容不可恢复。',
      chapterGoal: '本章目标',
      wordsShort: '字',
      todayShort: '今日',
      chaptersShort: '章',
  ...
  en: {
    ...
    todo: {
      ...
      priorityLow: 'Low',
      emptyPending: 'No pending todos, enjoy your day',
    ...
    collection: {
      ...
      urlPlaceholder: 'Enter URL, e.g. github.com',
      titlePlaceholder: 'Enter title (optional, auto-fetch if empty)',
      selectGroup: 'Select group',
      ungrouped: 'Ungrouped',
      all: 'All',
      search: 'Search bookmarks...',
      autoFetch: 'Auto-fetch title & icon',
      fetchSuccess: 'Fetched successfully',
      fetchFailed: 'Fetch failed, please enter manually',
      inputUrl: 'Please enter a URL',
      ...
      empty: 'No bookmarks yet, click Add to start',
    },
    // Novel
    novel: {
      statNovels: 'Novels',
      ...
      statToday: 'Today',
      statWordsShort: 'w',
      statChaptersShort: 'ch',
      newNovel: 'New Novel',
      editNovel: 'Edit Novel',
      title: 'Title',
      titlePlaceholder: 'Enter novel title...',
      category: 'Genre',
      categoryPlaceholder: 'Select or type a genre',
      categoryPresets: 'Fantasy,Urban,Science Fiction,History,Wuxia,Mystery,Romance,Games',
      status: 'Status',
      statusDraft: 'Draft',
      statusOngoing: 'Serializing',
      statusFinished: 'Completed',
      dailyGoal: 'Daily Word Goal',
      intro: 'Synopsis',
      introPlaceholder: 'One-line synopsis (optional)',
      enterTitle: 'Please enter a title',
      created: 'Novel created',
      updateSuccess: 'Novel updated',
      deleted: 'Novel deleted',
      deleteConfirm: 'Delete this novel? All chapters will be removed. This cannot be undone.',
      noIntro: 'No synopsis',
      empty: 'No novels yet. Create your first book and start writing!',
      unitYi: 'B',
      unitWan: 'W',
      unitQian: 'K',
      updatedAt: 'Updated',
      ...
      contentPlaceholder: 'Start your story here...',
      untitled: 'Untitled',
      noChapters: 'No chapters yet',
      chapterDeleted: 'Chapter deleted',
      deleteChapterConfirm: 'Delete this chapter? Its content cannot be recovered.',
